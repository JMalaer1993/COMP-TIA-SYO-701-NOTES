 ...
 * IPS - Intrusion Prevention System. Prevent attacks by detecting them and stopping them before they reach their target. This is an extension of IDS. A big difference with IPSs is that they are "in-line" with data streams. This allows them to actually block traffic. For this reason, it is said that IPSs are active, while IDSs are passive.
